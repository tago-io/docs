...
### 1. Static layer
In the static layer, you can use the widget configuration to input and choose a file. The file can come from our [files module](../../../files) or an external URL. In addition, the label input defines how the layer will be listed in the map.
...
Each variable value will display a GIS layer; you can control that using the [Dynamic Table widget](../../../widgets/dynamic-table-widget) or the [Input Form widget](../../../widgets/input-form-widget).  
