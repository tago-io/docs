...
This widget also accepts features like [metadata](https://help.tago.io/portal/en/kb/articles/503-metadata) and [series](https://help.tago.io/portal/en/kb/articles/5-other-concepts), that can be set in your variable data.
...
From the option 'Data From' on the right menu, add the [Blueprint device](https://help.tago.io/portal/en/kb/articles/455-blueprint-devices) and input the name of the variable that contains the **location** information.
...
Once the key is at hand, you will have to store the API key value inside a [Secret](https://help.tago.io/portal/en/kb/articles/secrets) on TagoIO. Go to your Admin, then the [Secrets](https://admin.tago.io/secrets) page, and create a new secret with the name of your map provider. In the **Secret Value**, paste the API Key and save.
...
In addition, the map widget supports [series](https://help.tago.io/portal/en/kb/articles/5-other-concepts), so you can group your variables' data in the same infobox.
...
Learn more about [Map filters](https://help.tago.io/portal/en/kb/articles/153-map-filters).
...
Learn more about [Geofence in map widgets](https://help.tago.io/portal/en/kb/articles/151-geofences-in-map-widgets).

---

## 6. Layer GIS

Customize your Map with GeoJSON or Shapefiles layers. Display boundaries, areas, roads, pipelines, and more. Learn more about [Map Layer GIS](https://help.tago.io/portal/en/kb/articles/528-map-layer-gis).
