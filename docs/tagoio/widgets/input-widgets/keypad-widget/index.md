...
tags: ["tagoio", "widgets"]
keywords: [tagoio, iot, widget, keypad, input]
---
...
When using a Blueprint dashboard, the field _Variable_ will not list variables to be picked because it doesn't know the devices linked to your Blueprint Device.
