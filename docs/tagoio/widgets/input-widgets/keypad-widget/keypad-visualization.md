...
- See [Keypad Widget](/docs/tagoio/widgets/keypad-widget)
- See [Creating Keypad Widgets](/docs/tagoio/widgets/keypad-widget#creating-your-own)
- See [Keypad Visualization](#) (this article)
- See [Keypad Data Manipulation](/docs/tagoio/keypad-data-manipulation)
