...
This article demonstrates how to create a Keypad Widget using the TagoIO Node.js SDK. See [Keypad Widget](/docs/tagoio/widgets/keypad-widget) and [TagoIO Node.js SDK](../sdk/nodejs-sdk) for more information.
