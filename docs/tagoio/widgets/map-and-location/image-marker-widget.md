...
This widget also accepts features like [metadata](/tagoio/devices/payload-parser/metadata.md) and [groups](/tagoio/devices/grouping-variables.md), which can be set in your variable data to alter how the widget behaves.
