...
This widget also accepts features like [metadata](link-to-metadata) that can be set in your variable data. (Refer to the Metadata documentation for details.)
