...
After converting a value, you can set the unit that appears next to it. Use the **Unit Origin** field to define where the displayed unit comes from. Learn more about [Display Units](/tagoio/widgets/general/displaying-units.md).
...
1. Create a new visualization preference in **TagoRUN** via **[Custom Settings](/tagoio/tagorun/getting-started/custom-settings.md)**.
