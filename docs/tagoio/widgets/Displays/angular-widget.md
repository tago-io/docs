...
- **Blueprint Dashboards** – Add the [Blueprint device](../../devices/blueprint-devices-entities) and type the name of the variable. Because the dashboard does not know which devices are linked to the Blueprint Device, the Variable selector will not list available variables.
