...
This widget also accepts features like [metadata](/docs/tagoio/payload-parser/metadata) and [groups](/docs/tagoio/devices/grouping-variables), which can be set in your variable data.
