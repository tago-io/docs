...
Send notifications to designated **Run Users** within your **Run**. You must specify the particular Run User you wish to notify. For notifying multiple users, please refer to our documentation on [notifications using analysis](/docs/tagoio/tagorun/getting-started/notifications-for-users.md).
...
Learn here how to create this secret: [Secrets](/docs/tagoio/getting-started/secrets.md).
...
Learn how to create this secret: [Secrets](/docs/tagoio/getting-started/secrets.md).
...
Ensure that the _Twilio SID_ and _Twilio Auth Token_ are set in TagoIO Secrets beforehand for them to appear in the dropdown menu. Use a Secret of type **Text**. Learn how to create this secret: [Secrets](/docs/tagoio/getting-started/secrets.md).
...
Learn more about [Running Analysis via Action](/docs/tagoio/actions/running-analysis-via-action.md).
