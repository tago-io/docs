...
Actions have the power to initiate scripts that run in the [Analysis](../analysis/index). This is a very powerful feature, as you can define exactly when your code will run.
