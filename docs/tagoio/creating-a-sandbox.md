...
To create a sandbox, just add a new [Profile](/tagoio/account/profiles) and use it for your tests. Make sure that all critical applications are running in another profile.
...
## Collaboration
Increase team collaboration and add more developers to your sandbox. To do this, share your profile with others by using the [Profiles & Teams](/tagoio/account/profiles) functionality.
