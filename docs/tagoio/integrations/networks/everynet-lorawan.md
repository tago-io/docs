...
1. **Access Authorizations**
   - Go to Devices.
   - Click on [Authorizations](/docs/tagoio/integrations/general/authorization.md) at the top of the page.
...
3. Fill out the fields:
   ...
   - **Application URL** – Use the endpoint format:  
     ...
     Replace `REGION` with your deployment region (e.g., `us-e1`, `eu-w1`). For a list of available regions, visit [TagoIO Network Integration](/docs/tagoio/integrations/.md).
