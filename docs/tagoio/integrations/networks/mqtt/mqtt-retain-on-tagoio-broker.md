...
This approach involves using the [Analysis](../../../analysis/index) and [Actions](../../../actions/actions) features to store the last message published to a topic and then resend it when a new client subscribes.
