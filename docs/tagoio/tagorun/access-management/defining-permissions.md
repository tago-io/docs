...
The resources available to grant permission depend on the Target you select, and the rules available depend on the resource selected. See [Defining Targets](/tagoio/tagorun/access-management/defining-targets.md).
