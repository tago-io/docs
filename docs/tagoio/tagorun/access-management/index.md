...
sidebar_position: 1
---
Access Management (AM) lets you securely grant access to specific resources in your TagoIO account. You create [Targets](/tagoio/tagorun/access-management/defining-targets.md) (users or things) and assign [Permissions](/tagoio/tagorun/access-management/defining-permissions.md) that determine which resources those Targets can access.
