...
Learn how to [set up the dictionary](/docs/tagoio/using-dictionaries-multi-language).
...
Refer to [Customize texts for the same language](/docs/tagoio/using-dictionaries-multi-language) for details.