...
> See [Sigfox network documentation](../integrations/connector-overview) or the original guide at </tagoio/sigfox>
...
You can also send data from your **Dashboard** using the [Input Form widget](/tagoio/input-form-widget). A script to perform a write in the parameter tab must be created using the [Analysis](/tagoio/analysis-overview).