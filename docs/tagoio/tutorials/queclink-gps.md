...
You can also set up notifications to send push notifications, SMS, or emails: [Notifications](/tagoio/getting-started/notification.md). Advanced analysis scripts are available here: [Scripts](/tagoio/analysis/creating-analysis.md).
