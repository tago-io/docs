...
You can also set up notifications to send push notifications, SMS, or emails: [Notifications](../notifications/notification). Advanced analysis scripts are available here: [Scripts](/docs/tagoio/analysis/creating-analysis).
