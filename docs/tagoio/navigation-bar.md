...
The color scheme for the bar, text, and icons can be configured in the **Theme** section of your Run. Discover more about [Run Themes](https://help.tago.io/portal/en/kb/articles/run-themes) and their capabilities.

### Implementing dynamic logos

Create a personalized experience for different user groups or roles by displaying unique logos in the navigation bar with the help of the [Tags System](https://help.tago.io/portal/en/kb/articles/tags).

1.  Navigate to the **Run module** → *Navigation Bar* → *Navigation Bar Logo* and enable the **Use dynamic logo** option.
2.  A new **Tag Match** field will appear, allowing you to specify a [tag key](https://help.tago.io/portal/en/kb/articles/tags) that corresponds to the custom logo URL.
...
2.  Click *Add new item* and configure the following options:
    ...
    - **Visibility options** (eye icon): allows you to restrict certain items to specific users using the [Tag System](https://help.tago.io/portal/en/kb/articles/tags) associated with the [Access Management](https://help.tago.io/portal/en/kb/articles/183-access-management) feature.
