...
If you want to keep your code private, share your connector directly with others instead of publishing it. Read more about [Sharing Connectors & Networks](/tagoio/devices/payload-parser/connector/sharing-connectors-networks.md).
