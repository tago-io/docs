...
After adding the device, a pop‑up will ask if you want to add a [dashboard](../dashboards/dashboard-overview). Use this option to get a dashboard to start and edit from there.
...
- [Dashboards](../dashboards/dashboard-overview)
...
Use our [Live Inspector](../live-inspector) to monitor raw data arriving on your account in real‑time.