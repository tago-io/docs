...
- **Widgets** – Some widgets allow you to edit device configuration parameters natively, such as the [Device List Widget](/tagoio/widgets/tables/device-list-widget.md).
