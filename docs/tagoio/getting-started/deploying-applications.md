...
When you are ready to scale up your application, you can [create scripts](/docs/tagoio/analysis/creating-analysis) to automate the [device](/docs/tagoio/devices/) registration, the [dashboard](/docs/tagoio/dashboards/creating-dashboard-tabs) creation, and the association between devices and users.
