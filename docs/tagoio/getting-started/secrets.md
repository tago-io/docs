...
- **Tags** — metadata to organize and filter secrets. [Tags](/docs/tagoio/getting-started/tags-system) are used across various assets within TagoIO and allow you to grant Analysis access to specific secrets via Access Management policies.
...
- Refer to the [Defining Actions](/docs/tagoio/actions/defining-actions) documentation for more details about this action.
