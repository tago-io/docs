...
You can monitor activities such as the addition and deletion of a Device (see [Device](../devices/)), changes in Access Management policies (see [Access Management](../tagorun/access-management/)), Analysis (see [Analysis](../analysis/)), and other similar actions.
