...
You can monitor activities such as the addition and deletion of a Device (see [Device](/docs/tagoio/devices/)), changes in Access Management policies (see [Access Management](/docs/tagoio/tagorun/access-management/)), Analysis (see [Analysis](/docs/tagoio/analysis/)), and other similar actions.
...
- Access Management policies — see [Access Management](/docs/tagoio/tagorun/access-management/)  
