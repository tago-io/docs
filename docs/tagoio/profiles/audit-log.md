...
You can monitor activities such as the addition and deletion of a Device (see [Device](../devices/index)), changes in Access Management policies (see [Access Management](../security/access-management)), Analysis (see [Analysis](../analysis/index)), and other similar actions.
