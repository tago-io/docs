...
TagoIO also enforces limits on the number of resources you can have and the amount of data displayed on your dashboards. Read more about [Resource Limits](/tagoio/my-account/billing/resource-limits.md) and [Data Output for Dashboards](/tagoio/dashboards/data-output-for-dashboards.md).
...
Check our [Control Tower add‑on](/tagoio/addons/control-tower.md).
...
>[*] You may also be able to adjust the limit individually **per device** depending on your plan. Check out our [Control Tower add‑on](/tagoio/addons/control-tower.md).
