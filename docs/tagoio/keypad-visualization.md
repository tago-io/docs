...
- Value – This is the value that will be sent to the [device](https://help.tago.io/portal/en/kb/articles/3-devices) or [analysis](https://help.tago.io/portal/en/kb/articles/120-creating-analysis) when a user submits the keypad. Learn more about [Keypad's Data Manipulation](https://help.tago.io/portal/en/kb/articles/232-keypad-data-manipulation).
