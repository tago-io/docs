...
<ParamsDetails {...require("./test-profile-service.ParamsDetails.json")}></ParamsDetails>

<RequestSchema {...require("./test-profile-service.RequestSchema.json")}></RequestSchema>

<StatusCodes {...require("./test-profile-service.StatusCodes.json")}></StatusCodes>
