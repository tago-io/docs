...
<Heading as={"h1"} className={"openapi__heading"} children={"Test Service Provider"}></Heading>
...
<ParamsDetails
  parameters={[
    ...
    },
    {
      ...
      in: "path",
      required: true,
      schema: { type: "string", enum: ["sms", "email"], example: "sms" },
  ...
  body={{
    ...
    content: {
      "application/json": {
        schema: {
          ...
          properties: {
            ...
            message: {
              type: "string",
              description:
                "Custom test message content (optional). If not provided, a default test message will be sent.",
        ...
        examples: {
          "Test SMS": { value: { to: "+15559876543", message: "This is a test SMS from TagoIO" } },
          "Test Email": {
            value: {
              to: "user@example.com",
      ...
      content: {
        "application/json": {
          schema: {
            ...
            properties: {
              status: { type: "boolean", example: false },
              message: { type: "string", example: "No service provider configured for the specified service type" },
            },
          },
        },
      },
      ...
      content: {
        "application/json": {
          schema: {
            ...
            properties: {
              status: { type: "boolean", example: false },
              message: { type: "string", example: "Failed to send test message: Invalid credentials" },
            },
          },
        },
      },
