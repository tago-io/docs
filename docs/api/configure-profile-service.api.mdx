...
<ParamsDetails {...require("./configure-profile-service.ParamsDetails.json")}></ParamsDetails>

<RequestSchema {...require("./configure-profile-service.RequestSchema.json")}></RequestSchema>

<StatusCodes {...require("./configure-profile-service.StatusCodes.json")}></StatusCodes>
