...
<ParamsDetails {...require("./generate-token.ParamsDetails.json")}></ParamsDetails>

<RequestSchema {...require("./generate-token.RequestSchema.json")}></RequestSchema>

<StatusCodes {...require("./generate-token.StatusCodes.json")}></StatusCodes>
