...
<Heading as={"h1"} className={"openapi__heading"} children={"Generate Token"}></Heading>
        ...
        "application/json": {
          schema: {
            ...
            properties: {
              result: {
                type: "object",
                properties: { widget_token: { type: "string", example: "ebe71a39-8f9f-4114-8bf3-6b3dcc19ad72" } },
              },
          ...
          examples: {
            "Generating a token": {
              value: { result: { widget_token: "ebe71a39-8f9f-4114-8bf3-6b3dcc19ad72" }, status: true },
            },
          },
        },
      },
