...
<ParamsDetails
  {...require("./get-device-token-with-serial-number-authorization.ParamsDetails.json")}
>
  
</ParamsDetails>

<RequestSchema
  {...require("./get-device-token-with-serial-number-authorization.RequestSchema.json")}
>
  
</RequestSchema>

<StatusCodes
  {...require("./get-device-token-with-serial-number-authorization.StatusCodes.json")}
>
