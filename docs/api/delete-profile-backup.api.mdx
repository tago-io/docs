...
<ParamsDetails {...require("./delete-profile-backup.ParamsDetails.json")}></ParamsDetails>

<RequestSchema {...require("./delete-profile-backup.RequestSchema.json")}></RequestSchema>

<StatusCodes {...require("./delete-profile-backup.StatusCodes.json")}></StatusCodes>
