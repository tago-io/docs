...
<ParamsDetails {...require("./download-profile-backup.ParamsDetails.json")}></ParamsDetails>

<RequestSchema {...require("./download-profile-backup.RequestSchema.json")}></RequestSchema>

<StatusCodes {...require("./download-profile-backup.StatusCodes.json")}></StatusCodes>
