...
<Heading as={"h1"} className={"openapi__heading"} children={"Export Entity Data"}></Heading>

<MethodEndpoint method={"post"} path={"/entity/{entity_id}/data/backup"} context={"endpoint"}></MethodEndpoint>
...
<ParamsDetails {...require("./export-entity-data.ParamsDetails.json")}></ParamsDetails>

<RequestSchema {...require("./export-entity-data.RequestSchema.json")}></RequestSchema>

<StatusCodes {...require("./export-entity-data.StatusCodes.json")}></StatusCodes>
