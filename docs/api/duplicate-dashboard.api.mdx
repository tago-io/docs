    ...
    content: {
      "application/json": {
        ...
        examples: {
          "Duplicate dashboard": {
            value: {
              setup: { is_configured: true, config: [{ id: "68c9baabb24379000ab1c8cc", name: "Freezer Simulator" }] },
          ...
          schema: {
            ...
            properties: {
              result: {
                type: "object",
                properties: {
                  dashboard_id: { type: "string", example: "62b0df7927ce4d0012cf3c10" },
                  message: { type: "string", example: "Copy sent" },
                },
              },
