...
<ParamsDetails {...require("./create-profile-backup.ParamsDetails.json")}></ParamsDetails>

<RequestSchema {...require("./create-profile-backup.RequestSchema.json")}></RequestSchema>

<StatusCodes {...require("./create-profile-backup.StatusCodes.json")}></StatusCodes>
