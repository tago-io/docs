...
<Heading as={"h1"} className={"openapi__heading"} children={"Send Data using Network"}></Heading>

<MethodEndpoint method={"post"} path={"/integration/network/data"} context={"endpoint"}></MethodEndpoint>
    ...
    content: {
      "application/json": {
        schema: {
          ...
          required: ["variable"],
          properties: {
            variable: { type: "string", example: "payload" },
            value: { type: "string", description: "Hexadecimal string payload", example: "41BC7E1F2A" },
            metadata: {
              type: "object",
              properties: { serial: { type: "string", description: "Device serial number", example: "SN123456789" } },
      ...
      "text/plain": {
        schema: {
          type: "string",
          description:
            "Arbitrary payload. Your [Network Payload Parser](/docs/tagoio/devices/payload-parser/) must normalize this text to the TagoIO array format accepted by application/json.\n",
        },
        examples: {
