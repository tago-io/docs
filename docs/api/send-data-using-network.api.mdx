...
<ParamsDetails {...require("./send-data-using-network.ParamsDetails.json")}></ParamsDetails>

<RequestSchema {...require("./send-data-using-network.RequestSchema.json")}></RequestSchema>

<StatusCodes {...require("./send-data-using-network.StatusCodes.json")}></StatusCodes>
