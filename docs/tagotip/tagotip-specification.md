...
custom_edit_url: https://github.com/tago-io/tagotip/edit/main/TagoTiP.md
---
...
> For the encrypted envelope (TagoTiP/S), see [TagoTiPs.md](/docs/tagotip/tagotips-specification).
...
> **Note:** For encryption without TLS, TagoTiP frames can be wrapped in a **TagoTiP/S** crypto envelope. See [TagoTiPs.md](/docs/tagotip/tagotips-specification).
...
> **Note:** TagoTiP/S uses additional credentials (Device Hash, Encryption Key) for the crypto envelope. See [TagoTiPs.md](/docs/tagotip/tagotips-specification).
...
> **Note:** The full frame structure described here applies to plaintext TagoTiP. When transmitted inside a TagoTiP/S envelope, a compact "headless" variant is used instead — see [TagoTiPs.md §4](/docs/tagotip/tagotips-specification#4-headless-inner-frame).
...
> The counter also serves as a nonce component in TagoTiP/S. See [TagoTiPs.md](/docs/tagotip/tagotips-specification).
...
> For encryption-based security without TLS, see [TagoTiPs.md](/docs/tagotip/tagotips-specification) (TagoTiP/S).
