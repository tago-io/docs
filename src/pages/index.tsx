    ...
    <header className={clsx('hero', styles.heroBanner)}>
      <div className="container">
        ...
        <p className="hero__subtitle">
          The Full-Stack IoT Platform to transform sensor data into smart solutions — simple, affordable, and free of cloud complexity.
        </p>
        <div className={styles.buttons}>
          <Link className={clsx('button button--lg', styles.demoButton)} to="https://tago.io/request-demo">
            Request a Demo
          </Link>
          <Link className="button button--outline button--secondary button--lg" to="https://tago.io/pricing">
            Get Started
          </Link>
        </div>
      </div>
